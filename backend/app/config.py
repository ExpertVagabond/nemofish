...
# Path: NemoFish/.env (relative to backend/app/config.py)
...
class Config:
    ...
    # Flask configuration
    SECRET_KEY = os.environ.get('SECRET_KEY', 'nemofish-nim-x402-secret')
    ...
    NEO4J_PASSWORD = os.environ.get('NEO4J_PASSWORD', 'nemofish')
